...
public class DollRoundTable : AliceCardModel
{
    ...
    static string text2 = StringHelper.Slugify("RoundTable");
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips => (new IHoverTip[3]
  {
    ...
    public DollRoundTable() : base(1, CardType.Power ,CardRarity.Uncommon, TargetType.Self)
	{
	}
