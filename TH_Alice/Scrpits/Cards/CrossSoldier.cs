...
public class CrossSoldier : AliceCardModel
{
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips => (new IHoverTip[2]
  {
    ...
    public CrossSoldier() : base(2, CardType.Attack ,CardRarity.Uncommon, TargetType.AnyEnemy)
	{
	}
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
        ...
        foreach(Creature mos in Owner.Creature.CombatState.Enemies) 
        {
            if (mos.IsAlive) 
            {
