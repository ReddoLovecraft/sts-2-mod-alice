...
public class Lostword : AliceCardModel
{
    protected override IEnumerable<DynamicVar> CanonicalVars =>
     [
        ...
        new CalculatedVar("CalculatedHits").WithMultiplier((CardModel card, Creature? _) =>ToolBox.GetDollKind(card.Owner.Creature)),
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips => (new IHoverTip[1]
  {
    ...
    public Lostword() : base(2, CardType.Attack ,CardRarity.Rare, TargetType.AllEnemies)
	{
	}
