...
public class GoliathDoll : AliceCardModel
{
    ...
    static string text2 = StringHelper.Slugify("Goliath");
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips => (new IHoverTip[2]
  {
    ...
    public GoliathDoll() : base(2, CardType.Skill, CardRarity.Uncommon, TargetType.Self)
	{
	}
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
       ...
       if(Owner.Character is AliceCharacter)
        ...
        await ToolBox.MakeDoll<GoliathPower>(base.Owner.Creature);
    }
