...
public class BombDoll : AliceCardModel
{
    ...
    static string text2 = StringHelper.Slugify("Bomb");
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips => (new IHoverTip[2]
  {
    ...
    public BombDoll() : base(1, CardType.Skill ,CardRarity.Common, TargetType.None)
	{
	}

    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
        for(int i = 0;i< base.DynamicVars["Power"].IntValue;i++)
        await ToolBox.MakeDoll<BombPower>(Owner.Creature);
    }
